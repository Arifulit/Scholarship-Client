...
const Advertisement = () => {
    return (
      <div className="w-full">
        ...
        <div className="carousel w-full h-[80vh] sm:h-[90vh] lg:h-[100vh]">
          {/* Slide 1 */}
          <div id="slide1" className="carousel-item relative w-full h-full">
            <img
              src="https://cdn.experteducation.com/wp-content/uploads/sites/15/2023/09/20180924/Scholarships-for-USA.jpg"
            ...
            />
            <div className="absolute inset-0 flex items-center justify-between px-5">
              <a href="#slide3" className="btn btn-circle bg-transparent border-none text-white text-4xl hover:text-gray-300">
                ❮
              </a>
              <a href="#slide2" className="btn btn-circle bg-transparent border-none text-white text-4xl hover:text-gray-300">
                ❯
              </a>
            </div>
          </div>
          ...
          <div id="slide2" className="carousel-item relative w-full h-full">
            ...
            />
            <div className="absolute inset-0 flex items-center justify-between px-5">
              <a href="#slide1" className="btn btn-circle bg-transparent border-none text-white text-4xl hover:text-gray-300">
                ❮
              </a>
              <a href="#slide3" className="btn btn-circle bg-transparent border-none text-white text-4xl hover:text-gray-300">
                ❯
