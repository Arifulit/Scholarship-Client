...
//       </Helmet>
//       <div className="container mx-auto mt-12 px-4 sm:px-8">
//         <div className="py-8">
...
//           >
//             <div>
//               <label htmlFor="scholarshipName" className="block ">
//                 Scholarship Name
//               </label>
//               <input
//                 id="scholarshipName"
...
//             </div>
//             <div>
//               <label htmlFor="subjectCategory" className="block ">
//                 Subject Category
//               </label>
//               <input
//                 id="subjectCategory"
...
//             </div>
//             <div>
//               <label htmlFor="applicationFees" className="block ">
//                 Application Fees
//               </label>
//               <input
//                 id="applicationFees"
...
//             <button
//               type="submit"
//               className="mt-4 px-4 py-2 bg-blue-500  rounded-md w-full"
//             >
//               Save Changes
//             </button>
//           </form>
