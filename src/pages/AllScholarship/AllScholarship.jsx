...
const AllScholarship = () => {
  ...
  return (
    <div>
      ...
      <Container>
        {/* Search & Sorting Box */}
        <div className="flex flex-col sm:flex-row justify-between items-center mt-6 py-4 w-full  p-4 shadow-md rounded-md">
          <div className="flex justify-start items-center w-full sm:w-1/2 mb-4 sm:mb-0">
            <input
              ...
              className="border border-gray-300 rounded-md px-4 py-3 w-full shadow-md focus:outline-none focus:ring focus:ring-blue-400"
            />
          </div>
          ...
          <div className="flex justify-end items-center space-x-4 w-full sm:w-1/2">
            ...
            <select
              ...
              className="border border-gray-300 px-4 py-3 rounded-md shadow-md w-auto focus:outline-none focus:ring focus:ring-blue-400"
            >
